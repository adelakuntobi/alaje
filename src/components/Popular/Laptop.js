...
function Laptop() {
  return (
    <>
      ...
      <Popularsample name="Dell Inspiron 15" price="385000" image={dell} desc="Preowned , Intel core i5(), 4 GB dedicated graphics , 16gb ram, 1 TB harddrive + 256 gb SSD, Red Keyboard light" />
      <Popularsample name="Macbook Air 2015" price="290000" image={mac2015} desc="Pre Owned, Intel Core i5 ,8gb ram ,256gb " />
      <Popularsample name="Macbook Pro 2017" price="290000" image={mac2017} desc="Pre owned, Intel Core i5 ,8gb ram  ,128 gb ssd" />
      <Popularsample name="Hp Envy x360" price="180000" image={hpEvny} desc="Preowned , HP envy x360, Intel core i5, 1 Tb, Touch screen, 8gb ram" />
      <Popularsample name="Hp Mini laptop" price="45000" image={mini} desc="Preowned, 2gb ram, 32 gb HDD" />
      <Popularsample name="Lenovo Thinkpad T490" price="190000" image={thinkPad} desc="New, 4gb ram , 256gb ssd ,Intel core i5 " />
      <Popularsample name="Lenovo Ideapad" price="70000" image={ideaPad} desc="Preowned, 4gb ram , 256gb SSD, Intel core i5 " />
    </>
  )
}
